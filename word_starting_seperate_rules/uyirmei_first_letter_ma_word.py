...
sentence = "மடல், மாடு, மிடல், மீன், முள், மூடி, மெய், மேனி, மையல், மொழி, மோதகம், மௌவல், மெவ்வாறு ஏ ஐ ஓ இவ்விடத்தில் சொல் சோறு கொல்லாது"
...
for word in sentence.split():
	print(word, uyirmei_ma_check(word, உயிர்மெய்_முதலெழுத்து_மவரிசை))
