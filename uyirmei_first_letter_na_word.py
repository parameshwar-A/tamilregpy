...
sentence = "நண்டு, நாரை, நிலம், நீர், நுங்கு, நூல், நெய், நேயம், நைகை, நெடி, நோக்கம், நௌவி, நெவ்வாறு ஏ ஐ ஓ இவ்விடத்தில் சொல் சோறு கொல்லாது"
...
for word in sentence.split():
	print(word, uyirmei_na_check(word, உயிர்மெய்_முதலெழுத்து_நவரிசை))
